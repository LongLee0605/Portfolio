...
export default function Home() {
  ...
  return (
    <section className="flex mx-auto max-w-[1920px] w-full relative flex-col lg:flex-row">
      {/* Left */}
      <div className="scale-[85%] lg:h-screen lg:w-[400px] lg:min-w-[360px] w-full lg:p-10 lg:pr-4 px-5 pt-10 pb-5 mx-0 lg:mr-10 flex-col flex gap-3 relative lg:fixed left-0 top-0 justify-center">
                        ...
                        <div className="flex gap-2">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {item?.skills?.map((skill, idx) => (
                              <p key={skill + idx} className="text-[#f2f3f499]">
                                • {skill}
                              </p>
                            ))}
                          </div>
